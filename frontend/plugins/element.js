...
import CharacterCountInputStandalone from '@/components/proxy/CharacterCountInputStandalone';
...
export default () => {
  ...
  Vue.component(CharacterCountInputStandalone.name, CharacterCountInputStandalone);
