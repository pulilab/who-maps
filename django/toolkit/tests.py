...
class ToolkitTests(APITestCase):
    ...
    def test_get_toolkit_data_statistics(self):
        ...
        self.assertEqual(ceil(response.json()[0]["domains"][0]["domain_percentage"]), 10)
        ...
        self.assertEqual(ceil(response.json()[0]["domains"][1]["domain_percentage"]), 15)
        self.assertEqual(ceil(response.json()[0]["axis_score"]), 12)
