...
class PermissionTests(SetupTests):
    ...
    def test_retrieve_project_and_draft_with_country_fields(self):
        ...
        # published
        self.assertEqual(response.json()['published']['fields'][0]['schema_id'], schema_2.id)
        self.assertEqual(response.json()['published']['fields'][0]['country'], cf2.country.id)
        self.assertEqual(response.json()['published']['fields'][0]['project'], cf2.project.id)
        self.assertEqual(response.json()['published']['fields'][0]['type'], cf2.type)
        self.assertEqual(response.json()['published']['fields'][0]['question'], cf2.question)
        self.assertEqual(response.json()['published']['fields'][0]['answer'], cf2.answer)
        self.assertEqual(response.json()['published']['fields'][1]['schema_id'], schema_1.id)
        self.assertEqual(response.json()['published']['fields'][1]['type'], cf1.type)
        self.assertEqual(response.json()['published']['fields'][1]['question'], cf1.question)
        self.assertEqual(response.json()['published']['fields'][1]['answer'], cf1.answer)

        # draft
        self.assertEqual(response.json()['draft']['fields'][0]['schema_id'], schema_2.id)
        self.assertEqual(response.json()['draft']['fields'][0]['country'], cf2.country.id)
        self.assertEqual(response.json()['draft']['fields'][0]['project'], cf2.project.id)
        self.assertEqual(response.json()['draft']['fields'][0]['type'], cf2.type)
        self.assertEqual(response.json()['draft']['fields'][0]['question'], cf2.question)
        self.assertEqual(response.json()['draft']['fields'][0]['answer'], cf2.draft)
        self.assertEqual(response.json()['draft']['fields'][1]['type'], cf1.type)
        self.assertEqual(response.json()['draft']['fields'][1]['question'], cf1.question)
        self.assertEqual(response.json()['draft']['fields'][1]['answer'], cf1.draft)
