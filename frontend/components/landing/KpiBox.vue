            ...
            <el-col :span="18" class="border-right">
                <div>
                    <graph-layout :span="24" horizontal>
                        <span class="kpiHeader"
                            >Distributions of projects’ stages 2</span
                        >
                        <template #graph>
                            <chart
                                type="polar-area"
                        ...
                        <template #legend>
                            <DataLegend :items="polarALegend">
                                <div>
                                    <span class="label"
                                        >Projects with no stage data</span
                                    >
                                    <span class="dots" />
                                    <span class="value">{{
                                        noStageDataSum
                ...
                <graph-layout>
                    ...
                    >
                        <div>
                            ...
                            <p>
                                <translate
                                    >At first level in the Health Focus
                                    Categories every project can contain the a
                                    Health Focus Category only once.</translate
                                >
                            </p>
                            <h2><translate>Health Focus Areas</translate></h2>
                            <p>
                                <translate
                                    >Health Focus Areas as sublevel of Health
                                    Focus Categories can contain multiple Health
                                    Focus Areas. Because of this, it may happen
                                    that the sum of the visible Health Focus
                                    Areas are more than the sum of Health Focus
                                    Categories, although the individual Health
                                    Focus Areas cannot exceed the number of
