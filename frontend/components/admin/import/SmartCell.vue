...
export default {
    ...
    parsedValue () {
      ...
      if (!this.column) {
        ...
        const resolver = {
          ...
          implementing_teams: this.stringArray,
  ...
  methods: {
    ...
    apiValue () {
      const isMultiple = ['platforms', 'implementing_partners', 'implementing_teams', 'implementing_viewers', 'health_focus_areas', 'hsc_challenges', 'his_bucket', 'licenses', 'interoperability_standards', 'custom_field', 'digitalHealthInterventions'];
