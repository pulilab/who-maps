        ...
        <div class="welcome">
          <div class="welcome-text">
            ...
            <el-button @click="goBack">
              <i class="el-icon-arrow-left"/><translate>Back</translate>
            </el-button>
          </div>
        </div>
      </div>
      ...
      <div class="subpage-content">
        ...
        <el-tabs tab-position="left">
          ...
          <el-tab-pane label="Terms of Use">
            <h1><translate>Terms of Use</translate></h1>
            ...
            <ul>
              ...
              statistics are anonymous and do not identify individual users.</translate></li>
            </ul>
            ...
            <p><translate>The Website and any content, materials, features, or products available or sold on or through the Website are available on an “as is” basis.</translate></p>
