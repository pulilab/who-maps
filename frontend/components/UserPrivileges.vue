<template>
  <ul class="UserTypeTextList">
    <template v-if="type === 'G'">
      <li><translate key="g-item-list-1">Can read/export responses to private Government questions</translate></li>
      <li><translate key="g-item-list-2">Can view when a project is approved/declined</translate></li>
    </template>
    <template v-if="type === 'CA'">
