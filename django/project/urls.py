...
urlpatterns = [
    ...
    path('projects/archive/<int:project_id>/',
         view=views.ProjectArchiveViewSet.as_view({
             'put': 'update'
         }),
    ...
    path("projects/admin-list/",
         view=views.ProjectAdminListViewSet.as_view({
             'get': 'list'
         }), name="project-admin-list"),
