<template>
  <div class="SingupComponent">
    <el-card :shadow="shadow" :body-style="{ padding: '0px' }">
      <div slot="header">
        <template v-if="token">
      ...
      >
        <fieldset>
          ...
          <el-form-item
            ...
            prop="email"
          >
            <el-input id="email" v-model="signupForm.email" />
          </el-form-item>
        ...
        <div class="CardActionsBottom">
          <el-row type="flex" justify="space-between" align="middle">
            <el-col :span="12" class="SecondaryAction LoginLink">
            ...
            <el-col :span="12" class="PrimaryAction">
              <el-button
                size="medium"
                native-type="submit"
