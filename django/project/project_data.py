    ...
    "interventions": [
        {
            "name": "Red Group",
            "subGroups": [
                {"name": "TB", "interventions": ["TB: preventing infection",
                                                 "TB: stopping progression from infection to active disease",
                                                 "TB: treating active disease"]},
                {"name": "Sexually Transmitted Infections", "interventions": ["STI: Preventing Acquisition",
                ...
                {"name": "HIV/AIDS Prevention and Treatment", "interventions": ["HIV: testing and diagnosis",
                                                                                ...
                                                                                "HIV: Prevention"]},
                {"name": "Diarrheal Diseases", "interventions": ["Diarrheal Dis: Breastfeeding promotion",
                                                                 "Diarrheal Dis: Water supply and sanitation improvement",
                                                                 "Diarrheal Dis: Oral rehydration therapy",
                                                                 "Diarrheal Dis: Zinc"]},
                {"name": "Vaccine-Preventable Diseases", "interventions": ["Vaccine: national immunization program",
                                                                           "Vaccine: fixed facility",
                                                                           "Vaccine: campaign",
                                                                           "Vaccine: mobile",
                                                                           "Vaccine: outreach"]},
                {"name": "Malaria", "interventions": ["Malaria: Prompt access to effective treatment",
                ...
                {"name": "Tropical Diseases", "interventions": ["Chagas Disease",
                                                                "Lymphatic Filariasis",
                                                                "Onchocerciasis",
                                                                "Leprosy", "Dengue", "Leishmaniasis", "African Trypanosomiasis"]},
                {"name": "Helminth Infections and Schistosomiasis", "interventions": ["Helminth: Anthelmintic Drug Treatment",
                                                                                      "Helminth: Improved Sanitation",
                                                                                      "Helminth: Health Education"]},
                {"name": "Acute Respiratory Infections in Children", "interventions": ["ARI: vaccines",
                                                                                       "ARI: case management"]},
                {"name": "Maternal and Perinatal Conditions", "interventions": ["Maternal: Fertility behavior change",
                ...
                {"name": "Newborn", "interventions": ["Newborn: Prepregnancy health and nutrition",
                ...
                {"name": "Stunting, Wasting, and Micronutrient Deficiency Disorders", "interventions": ["Nutrition: Promotion of Optimal Feeding of Infants and Young Children",
                ...
                {"name": "Cancer Control", "interventions": ["Cancer: Immunizations (e.g., HBV, HPV)",
                ...
                {"name": "Pregnancy Care", "interventions": ["Pregnancy: birth preparedness",
        ...
        },
        {
            "name": "Blue group",
            "subGroups": [
                {"name": "Diabetes", "interventions": ["Diabetes: prevention",
                                                       "Diabetes: screening",
                                                       "Diabetes: management"]},
                {"name": "Mental disorders", "interventions": ["Mental health screening",
                                                               "Mental health management and treatment"
                                                               ]},
                {"name": "Neurological Disorders", "interventions": ["Neurological Disorder Interventions"]},
                {"name": "Cardiovascular disease", "interventions": ["CVD Prevention",
                                                                     "CVD Treatment",
                                                                     "Long-Term Management of Existing Vascular Disease"]},
                {"name": "Respiratory Diseases of Adults", "interventions": ["Interventions for asthma",
                                                                             "Interventions for COPD",
                                                                             "Interventions for pneumonia and influenza"]},
                {"name": "Diseases of the Kidney and the Urinary System", "interventions": ["Hypertension interventions",
                                                                                            "Kidney and urinary tract Screening"]},
                {"name": "Skin disease", "interventions": ["Skin disease Interventions"]},
                {"name": "Oral Health", "interventions": ["Oral health education and promotion",
                                                          "Oral health treatment"]},
                {"name": "Unintentional Injuries", "interventions": ["Road traffic injuries prevention",
                                                                     "Poisonings",
                                                                     "Fall-related injuries",
                                                                     "Burn-related injuries",
                                                                     "Drowning"]},
                {"name": "Interpersonal Violence", "interventions": ["Interpersonal violence: Prevention Strategies"
        ...
        },
        {
            "name": "Green group",
            "subGroups": [
                {"name": "Water Supply, Sanitation, and Hygiene Promotion", "interventions": ["WASH: Safer Water",
                                                                                              "WASH: Hand Washing",
                                                                                              "WASH: Hygiene Education"
                                                                                              ]},
                {"name": "Indoor Air Pollution", "interventions": ["Indoor pollution: Source of pollution",
                                                                   "Indoor pollution: Improve living environment",
                                                                   "Indoor pollution: User behaviors"]},
                {"name": "Outdoor Air and Water Pollution", "interventions": ["Outdoor: Interventions to Reduce Air Pollution",
                                                                              "Outdoor: Interventions to Reduce Water Pollution"]},
                {"name": "Diet and Lifestyle Changes to prevent chronic disease", "interventions": ["Lifestyle: Avoid smoking",
                ...
                {"name": "Risk from High Blood Pressure, Cholesterol, and Bodyweight", "interventions": ["Risk: Interventions to Reduce Bodyweight",
                                                                                                         "Risk: Healthy diet (low sodium, high potassium",
                                                                                                         "Risk: Physical activity",
                                                                                                         "Risk: Medications to lower blood pressure"]},
                {"name": "Tobacco Addiction", "interventions": ["Tobacco: Smoking cessation treatment",
                                                                "Tobacco: Reducing exposure to passive tobacco smoke",
                                                                "Tobacco: Preventing initiation among youths and young adults"
                                                                ]},
                {"name": "Alcohol", "interventions": ["Alcohol: Education sessions and psychosocial counseling",
        ...
        },
        {
            "name": "Orange Group",
            "subGroups": [
                {"name": "Learning and Developmental Disabilities", "interventions": ["Learning Disability: Primary prevention to control the underlying cause or condition",
                ...
                {"name": "Loss of Vision and Hearing", "interventions": ["Childhood Blindness",
                ...
                {"name": "Interventions for Musculoskeletal Conditions", "interventions": ["Musculoskeletal: Preventive strategies",
                                                                                           "Musculoskeletal: Screening",
                                                                                           "Musculoskeletal: Symptomatic treatments",
                                                                                           "Musculoskeletal: Rheumitoid Arthritis",
                                                                                           "Musculoskeletal: Osteoporosis"]},
                {"name": "Pain Control", "interventions": ["Pain: Opioid treatment",
        ...
        },
        {
            "name": "Group bordeaux",
            "subGroups": [
                {"name": "Contraceptives", "interventions": ["Counseling",
                                                             "Permanent and Long-Term Methods",
                                                             "Temporary Methods", "Emergency Contraception",
                                                             "Social Marketing"]},
                {"name": "Health of Adolescents and Youth", "interventions": ["School - Based Health and Nutrition Programs",
                ...
                {"name": "Integrated Management of the Sick Child (integrated approaches to diarrhea, malaria, pneumonia, measles, other severe infections, and malnutrition)",
                 "interventions": ["IMNCI: Improve Health Worker Performance (assess signs and symptoms, classify illness, and provide appropriate treatment and education)",
                ...
                {"name": "Occupational Health", "interventions": ["Occupational: Strategies for Improving Working Conditions",
                                                                  "Occupational: Improvement of Access to Health Care",
                                                                  "Occupational: Surveillance and Reporting"]},
                {"name": "Natural Disaster Mitigation and Relief", "interventions": ["Disaster: Assessment of the Health Situation",
                ...
                {"name": "Emergency Medical Services", "interventions": ["EMS: Paramedics",
                                                                         "EMS: Lay response",
