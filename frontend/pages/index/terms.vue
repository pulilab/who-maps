      ...
      <div class="subpage-content">
        ...
        <el-tabs tab-position="left">
          ...
          <el-tab-pane label="Terms of Use">
            <h1>Terms of Use</h1>
            <p>Please read these Terms of Use before using the Website or any of its features. By using the
            Website, you accept and agree to be bound by these Terms. If you do not agree to the Terms,
            please exit the Website and do not access or otherwise use the Website.</p>
            <p>The following Terms of Use (“Terms”) govern the use of
              <a
              ...
              pages owned and operated by Results for Development Institute (“HRP,” “we,” or “our”).</p>
            <p>We reserve the right to modify, add, or delete any of these Terms at any time. Continued use of
            ...
            <p>This Site Does Not Provide Medical Advice, Diagnosis or Treatment.</p>
            <p>The contents of the Website such as texts, graphics, images, and all other information, whether
            ...
            licensed or knowledgeable in that area.</p>
            <h4>Accuracy of Content</h4>
            <p>The use of the Website and its content is at your own risk. HRP makes a reasonable effort to
            ...
            its own discretion and without giving any notice.</p>
            <p>HRP, its contributors, sponsors, administrators, or anyone else connected with HRP in any way
            whatsoever, cannot be responsible for any inaccurate or libelous information or for your use of
            the information contained in or linked from these web pages.</p>
            <h4>Intellectual Property Rights</h4>
            <p>The contents of the Website are protected by copyright, trademark, and other intellectual
            ...
            use.</p>
            <p>When you post or submit any material to this Website, you represent and warrant that you are the
            ...
            <p>We respect the intellectual property rights of others and require that people who use the Website
            ...
            that you are the copyright owner or are authorized to act on the copyright owner's behalf.</p>
            <h4>Message Boards and Other Interactive Features</h4>
            <p>Message boards, bulletin boards, blogs, and other services may be available on or through the
            ...
            misleading indications of origin, endorsements, or statements of fact.</p>
            <p>HRP reserves the right, but has no obligation, to monitor the content of the message boards,
            ...
            boards, bulletin boards, blogs, or other services on this Website.</p>
            <h4>Privacy Policy</h4>
            <p>We know that you care how information about you is used and shared and we are careful to ensure
            ...
            secure and confidential and is used only for the purposes for which it is provided.</p>
            <h4>Personal Information</h4>
            <p>The only personal information that we will collect is the personal information that you provide
            ...
            holding about you.</p>
            <h4>Purposes for which Personal Information May Be Used</h4>
            <p>Any personal information that you provide to us will be used only for the following purposes:</p>
            <ul>
              <li>To provide information or services to you as requested by you.</li>
              <li>To let you know about information and services from HRP in which you may be interested.</li>
              <li>For internal review.</li>
              <li>To improve the content of the website.</li>
              <li>To customize the content and /or layout of the website for each individual user.</li>
              <li>To notify users about updates to the website.</li>
              <li>To compile and disclose statistics about our users and their preferences. However, these
              statistics are anonymous and do not identify individual users.
              </li>
            </ul>
            <h4>Disclosure</h4>
            <p>We will not pass any of your personal information to any third party, other than members of HRP,
            without your consent.</p>
            <h4>Marketing and Advertising</h4>
            <p>No promotional offers or advertising will appear on the Website nor will your personal contact
            information ever be given, sold, or otherwise shared by HRP with third parties for advertising
            or marketing purposes.</p>
            <h4>Third Party Sites</h4>
            <p>You may be able to link from HRP's Website to third-party websites; conversely, third-party
            ...
            <p>To access certain services of the Website, you may need to provide information such as your name,
            ...
            password is governed by the terms of our Privacy Policy.</p>
            <h4>Disclaimers</h4>
            <p>This Website provides links to websites maintained by third parties. Any information, products,
            ...
            your own risk.</p>
            <p>The Website and any content, materials, features, or products available or sold on or through the Website are available on an “as is” basis.</p>
            <p><small>HRP, TO THE FULLEST EXTENT PERMITTED BY LAW,
            ...
            CORRECTED.</small></p>
            <p><small>WE MAKE NO WARRANTY THAT THE WEBSITE OR THE PROVIDED SERVICES WILL MEET USERS' REQUIREMENTS. NO
            ...
            DISSATISFIED WITH THE WEBSITE, YOUR SOLE REMEDY IS TO DISCONTINUE USING THE WEBSITE.</small></p>
            <p><small>WE TRY TO ENSURE THAT THE INFORMATION POSTED ON THE WEBSITE IS CORRECT AND UP-TO-DATE. WE RESERVE
            ...
            OTHER CONTENT.</small></p>
            <h4>Limitations on Liability</h4>
            <p>In no event will HRP or its directors, employees, or agents be liable to you or any third person
            ...
            Website.</p>
            <h4>Terminations</h4>
            <p>At any time and without notice, we may suspend, cancel, or terminate your right to use this
            ...
            suspension, cancellation, or termination.</p>
            <h4>Other Terms</h4>
            <p>These Terms constitute the entire agreement between you and HRP regarding the use of the Website
            ...
            right to asset and enforce provisions of the Terms directly and on their own behalf.</p>
          </el-tab-pane>

          <el-tab-pane label="Contact">
            <h1>Contact</h1>
            <p>Here comes the contact data...</p>
            <p><b>Email:</b>   <a href="mailto:digitalhealthatlas@gmail.com">digitalhealthatlas@gmail.com</a></p>
          </el-tab-pane>
        </el-tabs>

        <div>
          <h3>Get MAPS Toolkit now!</h3>

          <div>
            <p>A new toolkit has been launched to help mHealth implementers<br> to successfully and sustainably scale-up their innovations.</p>
          </div>

          <el-button @click="downloadPdf"><i class="el-icon-download" />Download Pdf</el-button>
        </div>
      </div>
    </div>
