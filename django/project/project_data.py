project_structure = {
    ...
    "interventions": [
        {
            "name": "Infectious Disease, Reproductive Health and Undernutrition",
            "subGroups": [
        ...
        {
            "name": "Non-communicable disease and Injury",
            "subGroups": [
                ...
                {"name": "Cardiovascular disease", "interventions": [
                    "CVD Prevention",
                    "CVD Treatment",
                    "Long-Term Management of Existing Vascular Disease"
                ]},
                {"name": "Respiratory Diseases of Adults", "interventions": [
                    "Interventions for asthma",
                    "Interventions for COPD",
                    "Interventions for pneumonia and influenza"
                ]},
                {"name": "Diseases of the Kidney and the Urinary System", "interventions": [
                    "Hypertension interventions",
                    "Screening"
                ]},
                {"name": "Skin disease", "interventions": [
        ...
        },
        {
            ...
            "subGroups": [
                ...
                {"name": "Outdoor Air and Water Pollution", "interventions": [
        ...
        {
            "name": "Consequences of Disease and Injury",
            "subGroups": [
        ...
        {
            "name": "Strengthening Health Services",
            "subGroups": [
                {"name": "Contraceptives", "interventions":
                    ['Counseling', 'Permanent and Long-Term Methods',
                ...
                {"name": "Integrated Management of the Sick Child", "interventions":
                    ['Integrated Intervention focused on ARI, diarrhea, malaria , and malnutrition',
