    ...
    >
      <el-button type="text" @click="toggleCategory">
        <template v-if="!arrowRight">
          <fa v-show="!categoryToggled && !alwaysExpandCategory" icon="angle-right" />
        ...
        <template v-if="arrowRight">
          <fa v-show="!categoryToggled && !alwaysExpandCategory" icon="angle-right" class="arrow-right" />
          <fa v-show="categoryToggled && !alwaysExpandCategory" icon="angle-down" class="arrow-right" />
        </template>
      </el-button>
    </div>
