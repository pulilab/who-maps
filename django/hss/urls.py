...
urlpatterns = [
    ...
    url(r"^projects/(?P<project_id>\d+)/hss/ageranges/$", view=views.AgeRangeView.as_view({"post": "create"}), name="hss-ageranges"),
    url(r"^projects/(?P<project_id>\d+)/hss/populations/$", view=views.PopulationView.as_view({"post": "create"}), name="hss-special-population"),
