...
class ListResultSerializer(serializers.Serializer):
    ...
    approved = serializers.ReadOnlyField(source="project__approval__approved")
    zero_cost = serializers.ReadOnlyField(source="project__data__zero_cost")
    codebase_accessible = serializers.ReadOnlyField(source="project__data__codebase_accessible")
    is_customizable = serializers.ReadOnlyField(source="project__data__is_customizable")
    free_replication = serializers.ReadOnlyField(source="project__data__free_replication")
    osi_licenses = serializers.ReadOnlyField(source="project__data__osi_licenses")
