...
api_info_router.register(r'api/projects/external/draft/', ExternalDraftAPI, base_name='project-external-draft')
api_info_router.register(r'api/projects/external/publish/', ExternalPublishAPI, base_name='project-external-publish')
